...
Sigil changes that. Instead of reacting to the market, your agents **act on your behalf**, continuously running a reasoning loop that evaluates your directives against real-time on-chain data.
...
2. Loads your natural-language directives (e.g., *"Airdrop 1 SOL if my balance drops below 0.5"*)
3. Sends the context to your LLM provider for reasoning
...
- **Web Dashboard** — A local React app for chat, analytics, and visual directive management
