---
title: Agent Loop
description: How each Sigil Wallet agent reasons, validates, and executes on a continuous loop.
---

Every Sigil Wallet agent runs an independent, continuous loop powered by [LangGraph](https://github.com/langchain-ai/langgraphjs). Each cycle follows a strict graph of nodes with conditional edges.
